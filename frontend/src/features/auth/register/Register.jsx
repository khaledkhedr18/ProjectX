  ...
  return (
    <div className="min-h-screen min-w-screen flex justify-center items-center bg-gray-900">
      <form
        ...
        className="bg-white p-10 w-full max-w-md rounded-xl shadow-lg"
      >
        ...
        <button
          type="button"
          className="w-full py-2.5 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50 transition"
        >
